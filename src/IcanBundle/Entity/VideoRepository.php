...
class VideoRepository extends EntityRepository
{
    ...
    /**
     * ListarOrdenadas: Lista las videos ordenadas
     *
     * @author Marcel
     */
    ...
    /**
     * TotalVideos: Total de video de la BD
     * @param string $sSearch Para buscar
     *
     * @author Marcel
     */
    public function TotalVideos($sSearch)
    {
        ...
        $consulta = 'SELECT COUNT(m.videoId) FROM IcanBundle\Entity\Video m ';
        $join = '';
        $where = '';
